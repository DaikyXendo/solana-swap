...
import { MINT_TOKEN_ADDRESS, MOCK_POOL, SOLSWAP_PROJECT_ID } from './constants';
import { NumericInput } from './components';
import SolSwapService from './services/solswap.service';
...
const Content: FC = () => {
    ...
    const handleSwap = async () => {
        try {
            setAppLoading(true);
            if (!wallet || !wallet.adapter.publicKey) return;
            const solswapService = new SolSwapService(anchorProgram as any, connection);
            const { swapTokenData, transaction } = await solswapService.swapToken(
        ...
        <div style={MIDDLE_STYLE}>
            <h1 style={{ textAlign: 'center' }}>
                <Avatar
                    ...
                    src="https://walletscrutiny.com/images/wIcons/iphone/com.solswap.solswap.jpg"
                />
                SolSwap Test Token Faucet
            </h1>
            <div
                style={{
                    marginTop: 40,
                            ...
                            {!wallet ? (
                                ...
                                <React.Fragment>
                                    ...
                                    <Tag style={{ margin: '10px 0px 20px 0px' }}>
                                        Contract address: {SOLSWAP_PROJECT_ID.toString()}
                                    </Tag>
                                    <div>
